...
public class RollYourOwnFunctionalInterfaceTest
{
    ...
    public void addFourInts()
    {
        ...
        FourIntFunction function = (addend1, addend2, addend3, addend4) -> addend1 + addend2 + addend3 + addend4;
    ...
    public void multiplyFourInts()
    {
        ...
        FourIntFunction function = (factor1, factor2, factor3, factor4) -> factor1 * factor2 * factor3 * factor4;
    ...
    public void addFirstThreeIntsAndDivideByLast()
    {
        ...
        FourIntFunction function = (addend1, addend2, addend3, divisor) -> (addend1 + addend2 + addend3) / divisor;
    ...
    private int applyFourIntFunction(int one, int two, int three, int four, FourIntFunction function)
    {
        ...
        return function.consume(one, two, three, four);
    }
    ...
    public interface FourIntFunction
    {
        ...
        int consume(int one, int two, int three, int four);
    }
}
